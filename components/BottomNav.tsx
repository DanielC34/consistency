...
export default function BottomNav() {
    ...
    return (
        <nav className="fixed bottom-0 w-full max-w-[480px] bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md border-t border-zinc-100 dark:border-zinc-900 px-8 py-4 flex justify-between items-center z-40 transition-colors duration-300">
            {items.map((item) => (
                <button
                    key={item.name}
                    className={`p-2 transition-all active:scale-90 ${item.active
                            ? 'text-lime-500'
